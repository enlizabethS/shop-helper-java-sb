...
import com.shophelperjavasb.shophelperjavasb.products.services.ProductService;
...
public class ProductController {
    ...
    public String productInfo(@PathVariable int id, Model model, Principal principal) {
